...
resource "aws_apprunner_service" "apprunner" {
  depends_on   = [aws_iam_role.apprunner-builder-role, aws_iam_role.apprunner-instance-role, aws_ecr_repository.apprunner-repository, aws_iam_role_policy.apprunner-ecr-policy]
